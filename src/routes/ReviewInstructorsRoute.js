...
const ReviewsController = require("../controller/ReviewsInstructorController ");
...
router
  ...
  .post(
    ...
    ReviewsController.setInstructorIdToBody,
    ReviewsValidator.createReviewInstructorValidator,
